...
namespace IVANGenXMLService
{
	...
	public class TK1TS
	{
		...
		public NoiDung_TK1TS NoiDung { get; set; }
	}

	[XmlRoot(ElementName = "NoiDung")]
	public class NoiDung_TK1TS
	{
		[XmlElement(ElementName = "LaoDong")]
		public List<LaoDong_TK1TS> LaoDong { get; set; }
	}

	[XmlRoot(ElementName = "LaoDong")]
	public class LaoDong_TK1TS
	{
		...
		public PhuLuc_TK1TS PhuLuc { get; set; }
	}


	[XmlRoot(ElementName = "ThanhVien")]
	public class ThanhVien_TK1TS
	{
		[XmlElement(ElementName = "STT")]
		public string STT { get; set; }
		[XmlElement(ElementName = "HoTen")]
	...
	public class PhuLuc_TK1TS
	{
		...
		public DSThanhVien_TK1TS DSThanhVien { get; set; }
	}

	[XmlRoot(ElementName = "DSThanhVien")]
	public class DSThanhVien_TK1TS
	{
		[XmlElement(ElementName = "ThanhVien")]
		public List<ThanhVien_TK1TS> ThanhVien { get; set; }
	}
